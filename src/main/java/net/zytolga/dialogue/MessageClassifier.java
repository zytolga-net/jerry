...
public class MessageClassifier {
    public enum Category {
        GREETING, FAREWELL, MOOD_QUESTION, COMPLIMENT, INSULT, THANKS, GENERAL
    }
    ...
    private static final List<Category> PRIORITY = List.of(Category.INSULT, Category.COMPLIMENT, Category.MOOD_QUESTION, Category.THANKS, Category.FAREWELL, Category.GREETING, Category.GENERAL);

    public MessageClassifier() {
        triggers.put(Category.GREETING, List.of("hello", "hi", "hey", "yo", "sup", "whats up", "what up", "good morning", "good afternoon", "good evening"));
    ...
    public Category classifyCategory(@NotNull String message) {
    ...
    public double classifySentimentDelta(@NotNull String message) {
        String lower = message.toLowerCase(Locale.ROOT);
        double total = 0.0;
    ...
    private boolean containsPhrase(String lowerMessage, @NotNull String phrase) {
        if (phrase.contains(" ")) {
